      ...
      <div class="container max-w-lg">
        <div class="section-inner panel mt-2 sm:mt-4 lg:mt-0">
          <div class="panel vstack items-center gap-3 lg:gap-4 mb-6 sm:mb-8 lg:mb-9 max-w-650px mx-auto text-center"
            ...
            <h1 class="h2 sm:h1 lg:display-6 xl:display-5 m-0">What separates you from others.</h1>
            <p class="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70">We focus on helping you to make useful
              content more accessible with an utlimate goal for a good sharing profit as a content creator.</p>
          </div>
                  ...
                  <div class="panel vstack justify-center gap-4 h-100">
                    <div>
                      <div class="panel vstack gap-2">
                        ...
                        <h3 class="h4 lg:h2 m-0">Share tools quickly and confidently in minutes</h3>
                        <p class="fs-6 lg:fs-5 opacity-70 dark:opacity-80">This powerfull tool eliminates the need to
                          leave Salesforce to get things done as I can create a custom proposal with dynamic pricing
                          tables. You can also customize your own dynamic versions.</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="panel vstack justify-center gap-4 h-100">
                    <div>
                      <div class="panel vstack gap-2">
                        ...
                        <h3 class="h4 lg:h2 m-0">Connect every part of your entire business</h3>
                        <p class="fs-6 lg:fs-5 opacity-70 dark:opacity-80">Keep data consistent, with native CRM
                  ...
                  <div class="panel vstack justify-center gap-4 h-100">
                    <div>
                      <div class="panel vstack gap-2">
                        ...
                        <h3 class="h4 lg:h2 m-0">Maintain compliance and control your apps</h3>
                        <p class="fs-6 lg:fs-5 opacity-70 dark:opacity-80">Improve security and trust with built-in
                          legally binding e-Signatures. Create pre-approved templates, content blocks and lock all legal
                          information to prevent costly mistakes.</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="panel vstack justify-center gap-4 h-100">
                    <div>
                      <div class="panel vstack gap-2">
                        ...
                        <h3 class="h4 lg:h2 m-0">Review quickly and confidently</h3>
                        <p class="fs-6 lg:fs-5 opacity-70 dark:opacity-80">Get real-time access to approvals, comments
                          and version tracking. Smart features like variables and conditional logic help you eliminate
                          Tool errors.</p>
                      </div>
                    </div>
                  </div>
