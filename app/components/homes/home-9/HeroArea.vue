      ...
      <div class="container">
        <div class="section-inner panel">
          ...
          <div class="panel vstack items-center gap-2 max-w-md mx-auto text-center px-4 lg:px-0 mt-6"
            ...
            <span
              class="fs-7 fw-medium py-narrow px-2 bg-dark text-white dark:bg-primary dark:text-dark rounded-pill">Get
              started today!</span>
            <h2 class="h2 xl:display-5 m-0 text-center">Seamless integrations with your
                ...
                <div class="hstack justify-center gap-2">
                  ...
                  <div class="rating panel">
                    <div class="hstack justify-center gap-narrow">
                      <i class="icon unicon-star-filled text-white p-narrow" style="background-color: #00b67a !important;"></i>
                      <i class="icon unicon-star-filled text-white p-narrow" style="background-color: #00b67a !important;"></i>
                      <i class="icon unicon-star-filled text-white p-narrow" style="background-color: #00b67a !important;"></i>
                      <i class="icon unicon-star-filled text-white p-narrow" style="background-color: #00b67a !important;"></i>
                      <i class="icon unicon-star-filled text-white p-narrow" style="background-color: #00b67a !important;"></i>
