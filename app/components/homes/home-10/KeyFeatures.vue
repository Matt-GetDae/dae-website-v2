<template>
  <!-- 
   <div id="key_features" class="key-features section panel overflow-hidden">
            <div class="section-outer panel py-6 lg:py-8 xl:py-10">
                <div class="container">
                    <div class="section-inner panel vstack gap-4 lg:gap-6 xl:gap-8 max-w-lg mx-auto" data-anime="onview: -100; targets: >*; translateY: [48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: anime.stagger(100);">
                        <div class="section-header vstack items-center gap-2 lg:gap-3">
                            <h2 class="h4 sm:h3 lg:h2 m-0 text-center max-w-650px mx-auto">More features</h2>
                        </div>
                        <div class="panel">
                            <div class="features-items row child-cols-12 lg:child-cols-4 justify-center g-2 md:g-4 col-match" data-anime="onview: -100; targets: >*; translateY: [48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: anime.stagger(100, {start: 400});">
                                <div>
  ...
  <div id="key_features" class="key-features section panel overflow-hidden">
    <div class="section-outer panel py-6 lg:py-8 xl:py-10">
      <div class="container">
        <div class="section-inner panel vstack gap-4 lg:gap-6 xl:gap-8 max-w-lg mx-auto"
          ...
          <div class="section-header vstack items-center gap-2 lg:gap-3"
            ...
            <h2 class="h4 sm:h3 lg:h2 m-0 text-center max-w-650px mx-auto">
              More features
            </h2>
          </div>
          <div class="panel" style="transform: translateX(0px) translateY(0px); opacity: 1">
            <div class="features-items row child-cols-12 lg:child-cols-4 justify-center g-2 md:g-4 col-match"
              ...
              <div>
                <div
                  class="features-item hstack items-center gap-2 p-2 bg-secondary hover:bg-tertiary dark:bg-gray-300 dark:bg-opacity-15 dark:hover:bg-primary hover:scale-105 transition-all duration-150 rounded-pill">
                  <div
