<template>
  <div id="how_it_works" class="how-it-works section panel overflow-hidden">
    <div class="section-outer panel">
      <div class="container">
        <div
          class="section-inner panel vstack border rounded-3 overflow-hidden bg-secondary dark:bg-gray-300 dark:bg-opacity-15"
          data-anime="onview: -200; translateY: [48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: 200;">
          <div class="row child-cols-12 md:child-cols justify-center col-match g-4 sep uc-grid" data-uc-grid>
            <div class="min-w-1/4">
            ...
            <div class="min-w-100 lg:min-w-1/4">
              <div class="panel vstack items-center gap-2 text-center p-5 xl:py-8">
                <span
          ...
          <div class="panel vstack p-6 xl:p-8 border-top">
            <div class="vstack md:hstack justify-center gap-1 mb-1 lg:mb-3"
              data-anime="translateY: [24, 0]; opacity: [0, 1]; easing: easeOutExpo; duration: 750; delay: 750;">
              <a href="#" class="btn btn-md btn-primary dark:bg-tertiary dark:text-primary px-3 w-auto border-0">
                <i class="icon-narrow unicon-chat-launch fw-bold"></i>
                <span>Start chatting</span>
              </a>
              <a href="#" class="btn btn-md btn-link fw-bold text-none text-primary dark:text-white">Free Watch Demo</a>
            </div>
            <div class="vstack sm:hstack items-center justify-center gap-1 fs-6"
