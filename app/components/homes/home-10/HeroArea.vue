...
<template>
    <div id="hero_header" class="hero-header section panel overflow-hidden">
            <div class="position-absolute top-0 start-0 end-0 h-screen bg-secondary dark:bg-gray-300 dark:bg-opacity-15 rounded-bottom-2 lg:rounded-bottom-5"></div>
                            ...
                            <div class="lg:col-10">
                                <div class="panel vstack gap-4 lg:gap-8">
                                    <div class="panel vstack justify-center items-center gap-2 px-2 pt-4 text-center">
                                        <h1 class="h2 md:h1 lg:display-5 m-0" data-anime="translateY: [10, 0]; opacity: [0, 1]; easing: easeOutExpo; duration: 450; delay: 250;">
                                            <span class="text-primary dark:text-tertiary">Connect Instantly,</span> <br class="d-none lg:d-block"> Communicate Seamlessly
                                        </h1>
                                        <p class="fs-6 xl:fs-4 xl:px-10 dark:text-white text-opacity-70" data-uc-splitext="types: 'words'" data-anime="targets: > *; translateX: [5, 0]; opacity: [0, 1]; easing: easeOutExpo; duration: 450; delay: anime.stagger(50, {start:650});">Stay connected with friends, family, and colleagues anywhere in the world.</p>
                                        <div class="vstack md:hstack justify-center gap-1 my-1 lg:my-3" data-anime="translateY: [24, 0]; opacity: [0, 1]; easing: easeOutExpo; duration: 750; delay: 750;">
                                            <NuxtLink to="/page-pricing" class="btn btn-md btn-outline-primary dark:border-tertiary dark:text-tertiary dark:hover:bg-tertiary dark:hover:text-primary-700 border-2 px-3 w-auto">
                                                <i class="icon-narrow unicon-chat-launch fw-bold"></i>
                                                <span>Start chatting</span>
                                            </NuxtLink>
                                            <a href="#" class="btn btn-md btn-link fw-bold text-none text-primary dark:text-tertiary">Free Watch Demo</a>
                                        </div>
                                        <div class="vstack sm:hstack items-center justify-center gap-1 fs-6 text-gray-900 dark:text-white" data-anime="translateY: [24, 0]; opacity: [0, 1]; easing: easeOutExpo; duration: 750; delay: 850;">
                                    ...
                                    <div class="panel mt-3 lg:mt-4 text-center">
                                        <div class="row child-cols-12 md:child-cols justify-center g-1 gx-4 lg:gx-0">
                                            <div>
