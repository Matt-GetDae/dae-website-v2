      ...
      <div class="container">
        <div class="section-inner panel">
          <div class="panel vstack items-center gap-2 xl:gap-3 mb-4 sm:mb-6 lg:mb-8 max-w-650px mx-auto text-center"
            ...
            <h2 class="h3 lg:h2 m-0">We’ve got you covered throughout the <span
                class="text-tertiary dark:text-primary">worker lifecycle</span></h2>
            <p class="fs-6 xl:fs-5 xl:px-8">IT and HR teams can automate onboarding, offboarding, and everything in
              between from within Lexend.</p>
          </div>
          <div class="row child-cols-12 md:child-cols-6 lg:child-cols-4 col-match g-2 lg:g-4"
            data-anime="onview: -200; targets: >*; translateY: [48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: anime.stagger(100, {start: 200});">
            <div>
              <div
            ...
            <div class="md:col-6">
              <div class="panel overflow-hidden bg-primary-300 text-gray-900 rounded-2 lg:rounded-3">
                <div class="panel vstack items-center text-center gap-2 p-3 lg:p-4 xl:p-6">
                  ...
                  <p class="fs-6 md:fs-5 lg:fs-4 m-0">Maximize your productivity by connecting our SaaS solution to the
            ...
            <div class="col-12 lg:col-6">
              <div class="panel overflow-hidden min-h-450px bg-tertiary text-white rounded-2 lg:rounded-3 uc-dark">
                <div class="panel vstack items-center text-center gap-2 p-3 md:p-4 xl:p-6">
                  ...
                  <p class="fs-6 md:fs-5 lg:fs-4 m-0 xl:px-4 text-center">Rely on our knowledgeable support team to help
                    you get the most out of our platform. We're available to answer questions and provide guidance.</p>
                  <a href="#" class="btn btn-sm btn-primary border px-2 mt-2">
