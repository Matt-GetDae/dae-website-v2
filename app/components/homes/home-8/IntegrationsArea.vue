      ...
      <div class="container">
        <div class="section-inner panel max-w-lg mx-auto">
          <div class="panel vstack items-center gap-2 xl:gap-3 mb-4 sm:mb-6 lg:mb-8 mx-auto text-center"
            ...
            <p class="fs-6 xl:fs-5 xl:px-8">Connect your tools, connect your teams. With over 200 apps already available
              in our directory, your team’s favourite tools are just a click away.</p>
          </div>
          <div class="panel vstack items-center gap-6 lg:gap-8"
            data-anime="onview: -200; targets: >*; translateY: [48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: anime.stagger(100, {start: 200});">
            ...
            <NuxtLink to="/page-integrations" class="btn btn-md xl:btn-lg btn-primary border px-3 lg:px-5 w-auto">Browse
              all integrations</NuxtLink>
          </div>
        </div>
      </div>
    </div>
