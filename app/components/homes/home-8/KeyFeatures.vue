<template>
  <div id="key_features" class="key-features section panel overflow-hidden uc-dark">
    <div
      class="section-outer panel py-6 md:py-8 xl:py-10 lg:mx-2 lg:rounded-2 bg-tertiary-700 text-white text-opacity-70">
      <div class="container sm:max-w-lg">
        <div class="section-inner panel">
          <div
            ...
            <h2 class="h3 lg:h2 m-0">End-to-End data management Solutions</h2>
          ...
          <div class="pre-cta vstack items-center gap-1 max-w-400px lg:max-w-750px mx-auto text-center mt-6 xl:mt-10"
            ...
            <div class="mb-2 lg:mb-3">
              <NuxtLink to="/page-pricing-2" class="btn btn-md xl:btn-lg btn-primary border px-3 lg:px-5 w-auto">
